...
namespace Type
{
    namespace BASHS
    {
        namespace TokenType
        {
            ...
            constexpr uint32 String          = 1;
            constexpr uint32 Variable        = 2;
            constexpr uint32 Command         = 3;
            constexpr uint32 Keyword         = 4;
            constexpr uint32 Number          = 5;
            constexpr uint32 Operator        = 6;
            constexpr uint32 Pipe            = 7;
            constexpr uint32 Redirect        = 8;
            constexpr uint32 BlockOpen       = 9;
            constexpr uint32 BlockClose      = 10;
            constexpr uint32 Semicolon       = 11;
            constexpr uint32 Word            = 12;
            constexpr uint32 Shebang         = 13;
            constexpr uint32 Substitution    = 14;
            constexpr uint32 ExpressionOpen  = 15;
            constexpr uint32 ExpressionClose = 16;

        } // namespace TokenType

        class BASHSFile : public TypeInterface, public GView::View::LexicalViewer::ParseInterface
        {
            ...
            uint32 TokenizeVariable(const GView::View::LexicalViewer::TextParser& text, GView::View::LexicalViewer::TokensList& tokenList, uint32 pos);
        ...
        namespace Panels
        {
            ...
            {
                Reference<GView::Type::BASHS::BASHSFile> bash;
              ...
              public:
                Information(Reference<GView::Type::BASHS::BASHSFile> bash);
